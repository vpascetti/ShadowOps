...
export async function upsertJob(tenantId, job) {
  ...
  const cols = [
    'tenant_id','job_id','job','work_center','start_date','due_date','qty_released','qty_completed','hours_to_go','parts_to_go','prod_start_time','prod_end_time','eplant_id','eplant_company','origin','firm','ingested_at'
  ]
